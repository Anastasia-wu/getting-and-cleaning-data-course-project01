...
activity- the type of activity performed when measurements were made
Measurements
These are the mean and std for the corresponding quantities measured by the device.
...
Activity Labels
This shows the keys for each of the activities measured.
